...
Using a fork by mrguen https://github.com/mrguen/Adafruit_SSD1306
...
This example is for a 64x32 size display using I2C to communicate

Adapted by mrguen https://github.com/mrguen.
...
void setup()   {                
  ...
  display.println("Examples");
  display.println("of using");
